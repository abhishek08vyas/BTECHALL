...
public class Employee extends Login {
	...
	public void EmployeeLogin() {
		...
		if (lstEmpInfo == null || lstEmpInfo.size() == 0) {
			System.out.println("Currently employee users not available!!Please contact administrator.");
			return;
		}
				...
				do {
					try {
						...
						if (lstEmpInfo.get(i).GetLeave() == 0) {
							System.out.println("You can't apply more leave!!Please contact reporting authority.");
							break;
						}
						...
						System.out.println("Only integer value is accept!!");
						bIsValidInput = false;
						continue;
					}
