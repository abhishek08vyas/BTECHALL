		...
		do {
			...
			case "1":
				...
				do {
					...
					if(!adminLgn.checkadmin(sUserId, sPassword)){
						checklogin = true;
			...
			case "2":
				...
				do {
					...
					reportingAuthority = reportingAuthority.RALogin(raUserName, raPassword, lstRAInfo);
					if(reportingAuthority == null){
						ralogin = true;
						System.out.println("------------ INVALID CREDENIALS --------------");
					}
			...
			case "3":
				...
				do {
					...
					employee=  employee.employeeLogin(employeeUserName, employeePassword, lstEmpInfo);
					if(employee == null){
						employeelogin = true;
						System.out.println("------------ INVALID CREDENIALS --------------");
					}					
